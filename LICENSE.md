...
PULSE8.ai Cortex may be used for commercial purposes without a separate commercial license. However, if you and your Affiliates, on a consolidated basis, meet either of the following thresholds (A or B), you must obtain a separate commercial license from PULSE8.ai before continuing such use:

A. Monthly Active Users (MAU) exceed 1 million.

B. Total Monthly Revenue (TMR) exceeds USD 5 million.

For the purposes of this section, MAU includes end-users of any product or service that integrates PULSE8.ai Cortex, as well as AI agents, API consumers, or MCP clients connecting to an instance of PULSE8.ai Cortex.

**2. Service Attribution Obligation**

If you provide products or services to third parties that integrate PULSE8.ai Cortex — whether as a hosted API, managed knowledge service, embedded backend, or any other form — you must clearly and prominently indicate, in the relevant product or service interface or in publicly available documentation, that PULSE8.ai Cortex is used.
