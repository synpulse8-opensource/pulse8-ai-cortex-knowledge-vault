...
apply_defaults() {
    ...
    export QMD_SEARCH_MODE="${QMD_SEARCH_MODE:-hybrid}"
    export QMD_SEARCH_TIMEOUT_SECONDS="${QMD_SEARCH_TIMEOUT_SECONDS:-120}"
...
QMD_SEARCH_TIMEOUT_SECONDS=${QMD_SEARCH_TIMEOUT_SECONDS:-120}
